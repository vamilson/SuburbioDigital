...
<html lang="pt_BR">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top"><img class="logo" src="img/logos/logo-sd.png">Subúrbio Digital</a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav text-uppercase ml-auto">
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="#services">Oportunidades</a>
            </li>
            <!-- <li class="nav-item">
    ...
    <header class="masthead">
      <div class="container">
        <div class="intro-text">
          <div class="intro-lead-in">Conexão Além dos Limites Sociais!</div>
          <div class="intro-heading text-uppercase">Próximo a Você!</div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12 text-center">
            ...
            <h3 class="section-subheading text-muted">Para sua residência ou estabelecimento!</h3>
          </div>
        </div>
            ...
            <ul class="timeline">
              <li>
                ...
                <div class="timeline-panel">
                  ...
                  <div class="timeline-body">
                    <p class="text-muted">Infelizmente, grande parte das comunidades periféricas no Brasil sofrem por não ter o fácil acesso a serviços comuns oferecidos mundo afora, e Internet Banda Larga se enquadra nesta questão. Pensando nisso, o projeto Subúrbio Digital foi criado para facilitar o acesso a tecnologia, informação e comunicação. Tendo um baixo custo, o projeto foi rapidamente abraçado pela comunidade, o que permitiu a expansão da inclusão digital no ambiente.</p>
                  </div>
                </div>
              </li>
              <li class="timeline-inverted">
                ...
                <div class="timeline-panel">
                  <div class="timeline-heading">
                    <h4>Junho de 2017</h4>
                    <h4 class="subheading">Qualidade</h4>
                  </div>
                  <div class="timeline-body">
                    <p class="text-muted">Buscando a melhoria contínua do projeto, houve a implementação técnica de fibras ópticas e reestruturação do Data Center, o que elevou a qualidade e performance na entrega do serviço. </p>
                  </div>
                </div>
              </li>
              <li>
                ...
                <div class="timeline-panel">
                  <div class="timeline-heading">
                    ...
                    <h4 class="subheading">Renovação</h4>
                  </div>
                  <div class="timeline-body">
                    <p class="text-muted">Novos profissionais que acreditam no projeto passaram a fazer parte do time. Novas políticas foram aplicadas e técnicas aperfeiçoadas para o atendimento. Facilitado comunicação pelos meios digitais, como FaceBook e WhatsApp.</p>
                  </div>
                </div>
              </li>
              <li class="timeline-inverted">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-3 col-sm-6">
            <a href="http://www.nordestedigitalssa.com.br">
              <img class="img-fluid d-block mx-auto" src="img/logos/nordestedigital.webp" alt="">
            </a>
          </div>
          <div class="col-md-3 col-sm-6">
            <a href="http://www.jairofiuza.com.br">
              <img class="img-fluid d-block mx-auto" src="img/logos/jairofiuza.png" alt="">
            </a>
          </div>
          <div class="col-md-3 col-sm-6">
            <a href="#">
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <ul class="list-inline social-buttons">
              ...
              <li class="list-inline-item">
                <a href="http://fb.com/suburbiodigital/">
                  <i class="fab fa-facebook-f"></i>
                </a>
              </li>
              <li class="list-inline-item">
